			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sumfree-display": {
								"semanticObject": "sumfree",
								"action": "display",
								"description": "A freestyle app for sum",
								"title": "Sumar",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sumfree",
									"url": sap.ui.require.toUrl("sumfree")
								}
							}
						}
					}
